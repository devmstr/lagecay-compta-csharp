...
public class rptAchat : XtraReport
{
	...
	{
		Periode.Text = "du mois de " + monModule.gMois[monModule.eMOIS] + " de l'exercice " + monModule.eExercice;
	...
	private void InitializeComponent()
	{
		...
		{
			new ExpressionBinding("BeforePrint", "Text", "[DATEECR]")
		});
		...
		Titre.EditOptions.Enabled = true;
		...
		Titre.Text = "ETAT DES TAXES SUR ACHATS";
		Titre.TextAlignment = TextAlignment.MiddleCenter;
		GroupHeader1.Controls.AddRange(new XRControl[7] { d2, d1, xrLabel5, xrLabel4, xrLabel3, xrLabel2, xrLabel1 });
		GroupHeader1.HeightF = 45.49993f;
		GroupHeader1.Name = "GroupHeader1";
		d2.Borders = BorderSide.All;
		d2.CanGrow = false;
		d2.Font = new Font("Arial", 9.75f, FontStyle.Bold);
		d2.LocationFloat = new PointFloat(972.4582f, 0f);
		d2.Multiline = true;
		d2.Name = "d2";
		d2.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		d2.SizeF = new SizeF(123.9583f, 45.49993f);
		d2.StylePriority.UseBorders = false;
		d2.StylePriority.UseFont = false;
		d2.StylePriority.UseTextAlignment = false;
		d2.Text = "TVA";
		d2.TextAlignment = TextAlignment.MiddleCenter;
		d2.TextFormatString = "{0:#,##0.00;(#,##0.00); }";
		d1.Borders = BorderSide.Top | BorderSide.Bottom;
		d1.CanGrow = false;
		d1.Font = new Font("Arial", 9.75f, FontStyle.Bold);
		d1.LocationFloat = new PointFloat(848.4999f, 0f);
		d1.Multiline = true;
		d1.Name = "d1";
		d1.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		d1.SizeF = new SizeF(123.9583f, 45.49993f);
		d1.StylePriority.UseBorders = false;
		d1.StylePriority.UseFont = false;
		d1.StylePriority.UseTextAlignment = false;
		d1.Text = "Montant Hors Taxes";
		d1.TextAlignment = TextAlignment.MiddleCenter;
		d1.TextFormatString = "{0:#,##0.00;(#,##0.00); }";

...
public class CommuneAR : ICustomFunction, IFunction
{
	private const string functionName = "CommuneAR";

	private readonly ParameterInfo[] functionParameters;

	public string Name => "CommuneAR";
	...
	{
		OleDbCommand oleDbCommand = new OleDbCommand("SELECT Villes.LIBAR FROM Villes INNER JOIN Dossiers ON Villes.CP = Dossiers.CPCommune  WHERE  UNI='" + monModule.gUNI + "'", monModule.gbase);

...
public class ADRS : ICustomFunction, IFunction
{
	private const string functionName = "ADRS";

	private readonly ParameterInfo[] functionParameters;

	public string Name => "ADRS";
	...
	{
		OleDbCommand oleDbCommand = new OleDbCommand("SELECT ADR  FROM Dossiers  WHERE  UNI='" + monModule.gUNI + "'", monModule.gbase);

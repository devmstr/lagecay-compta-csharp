...
public class Ecritures_tTableAdapter : Component
{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
	public Ecritures_tTableAdapter()
	{
	...
	private void InitAdapter()
	{
		...
		tableMapping.DataSetTable = "Ecritures_t";
		...
		_adapter.DeleteCommand.CommandText = "DELETE FROM `Ecritures_t` WHERE (((? = 1 AND `UNI` IS NULL) OR (`UNI` = ?)) AND ((? = 1 AND `Exercice` IS NULL) OR (`Exercice` = ?)) AND ((? = 1 AND `JA` IS NULL) OR (`JA` = ?)) AND ((? = 1 AND `NOP` IS NULL) OR (`NOP` = ?)) AND ((? = 1 AND `LIG` IS NULL) OR (`LIG` = ?)) AND ((? = 1 AND `CPT` IS NULL) OR (`CPT` = ?)) AND ((? = 1 AND `TRS` IS NULL) OR (`TRS` = ?)) AND ((? = 1 AND `DAT` IS NULL) OR (`DAT` = ?)) AND ((? = 1 AND `LIB` IS NULL) OR (`LIB` = ?)) AND ((? = 1 AND `DEB` IS NULL) OR (`DEB` = ?)) AND ((? = 1 AND `CRE` IS NULL) OR (`CRE` = ?)) AND ((? = 1 AND `PTG` IS NULL) OR (`PTG` = ?)) AND ((? = 1 AND `PTGX` IS NULL) OR (`PTGX` = ?)) AND ((? = 1 AND `RAP` IS NULL) OR (`RAP` = ?)) AND ((? = 1 AND `Jour` IS NULL) OR (`Jour` = ?)) AND ((? = 1 AND `UserC` IS NULL) OR (`UserC` = ?)) AND ((? = 1 AND `DateC` IS NULL) OR (`DateC` = ?)) AND ((? = 1 AND `UserM` IS NULL) OR (`UserM` = ?)) AND ((? = 1 AND `DateM` IS NULL) OR (`DateM` = ?)) AND (`ID` = ?))";
		...
		_adapter.InsertCommand.CommandText = "INSERT INTO `Ecritures_t` (`UNI`, `Exercice`, `JA`, `NOP`, `LIG`, `CPT`, `TRS`, `DAT`, `LIB`, `DEB`, `CRE`, `PTG`, `PTGX`, `RAP`, `Jour`, `UserC`, `DateC`, `UserM`, `DateM`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	private void InitCommandCollection()
	{
		...
		_commandCollection[0].CommandText = "SELECT        Ecritures_t.*\r\nFROM            Ecritures_t \r\nORDER BY LIG";
	...
	public virtual int Fill(DataSet1.Ecritures_tDataTable dataTable)
	{
	...
	public virtual DataSet1.Ecritures_tDataTable GetData()
	{
		Adapter.SelectCommand = CommandCollection[0];
		DataSet1.Ecritures_tDataTable dataTable = new DataSet1.Ecritures_tDataTable();
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual int Update(DataSet1.Ecritures_tDataTable dataTable)
	{
	...
	{
		return Adapter.Update(dataSet, "Ecritures_t");
	}
	...
	public virtual int Delete(string Original_UNI, int? Original_Exercice, string Original_JA, string Original_NOP, int? Original_LIG, string Original_CPT, string Original_TRS, DateTime? Original_DAT, string Original_LIB, decimal? Original_DEB, decimal? Original_CRE, string Original_PTG, string Original_PTGX, string Original_RAP, byte? Original_Jour, string Original_UserC, DateTime? Original_DateC, string Original_UserM, DateTime? Original_DateM, int Original_ID)
	{
		...
		if (Original_Jour.HasValue)
		{
			...
			Adapter.DeleteCommand.Parameters[29].Value = Original_Jour.Value;
		}
		else
		{
		...
		else
		{
			...
			Adapter.DeleteCommand.Parameters[31].Value = Original_UserC;
		}
		if (Original_DateC.HasValue)
		{
			Adapter.DeleteCommand.Parameters[32].Value = 0;
			Adapter.DeleteCommand.Parameters[33].Value = Original_DateC.Value;
		}
		else
		{
		...
		else
		{
			...
			Adapter.DeleteCommand.Parameters[35].Value = Original_UserM;
		}
		if (Original_DateM.HasValue)
		{
			Adapter.DeleteCommand.Parameters[36].Value = 0;
			Adapter.DeleteCommand.Parameters[37].Value = Original_DateM.Value;
		}
		else
		{
		...
		Adapter.DeleteCommand.Parameters[38].Value = Original_ID;
	...
	public virtual int Update(string UNI, int? Exercice, string JA, string NOP, int? LIG, string CPT, string TRS, DateTime? DAT, string LIB, decimal? DEB, decimal? CRE, string PTG, string PTGX, string RAP, byte? Jour, string UserC, DateTime? DateC, string UserM, DateTime? DateM, string Original_UNI, int? Original_Exercice, string Original_JA, string Original_NOP, int? Original_LIG, string Original_CPT, string Original_TRS, DateTime? Original_DAT, string Original_LIB, decimal? Original_DEB, decimal? Original_CRE, string Original_PTG, string Original_PTGX, string Original_RAP, byte? Original_Jour, string Original_UserC, DateTime? Original_DateC, string Original_UserM, DateTime? Original_DateM, int Original_ID)
	{
		...
		if (Original_Jour.HasValue)
		{
			...
			Adapter.UpdateCommand.Parameters[48].Value = Original_Jour.Value;
		}
		else
		{
		...
		else
		{
			...
			Adapter.UpdateCommand.Parameters[50].Value = Original_UserC;
		}
		if (Original_DateC.HasValue)
		{
			Adapter.UpdateCommand.Parameters[51].Value = 0;
			Adapter.UpdateCommand.Parameters[52].Value = Original_DateC.Value;
		}
		else
		{
		...
		else
		{
			...
			Adapter.UpdateCommand.Parameters[54].Value = Original_UserM;
		}
		if (Original_DateM.HasValue)
		{
			Adapter.UpdateCommand.Parameters[55].Value = 0;
			Adapter.UpdateCommand.Parameters[56].Value = Original_DateM.Value;
		}
		else
		{
		...
		Adapter.UpdateCommand.Parameters[57].Value = Original_ID;
